/*
 *
 * D2S-tools agkanogiannis.d2stools.ReadD2
 *
...
public class ReadD2 extends Read implements ReadD2Interface{
	...
	public ReadD2(Read read) {
		super(read.getReadId(), read.getHeader(), read.getSeq(), read.getQual());
